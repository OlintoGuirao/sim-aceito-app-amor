  ...
  return (
    <div className="text-center mb-12">
      ...
      <div className="flex justify-center space-x-8 mt-6">
        ...
        <div className="w-2 h-2 bg-wedding-palha rounded-full animate-sparkle" style={{ animationDelay: '0.5s' }}></div>
        <div className="w-2 h-2 bg-wedding-accent rounded-full animate-sparkle" style={{ animationDelay: '1s' }}></div>
      </div>
    </div>
  );
};
