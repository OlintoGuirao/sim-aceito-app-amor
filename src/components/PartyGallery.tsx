            ...
            <div className="p-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Input placeholder="Adicione um comentário..." value={newComment} onChange={e => setNewComment(e.target.value)} onClick={e => e.stopPropagation()} className="flex-1 bg-wedding-secondary" />
                  <Button onClick={e => {
                e.stopPropagation();
