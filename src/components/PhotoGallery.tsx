...
const PhotoGallery: React.FC = () => {
  ...
  return <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {photos.map((photo, index) => <Card key={photo.id} className="overflow-hidden cursor-pointer hover:shadow-lg transition-all transform hover:scale-105" onClick={() => setSelectedPhoto(index)}>
